...
class ChaincodeActionDeserializer {
    ...
    {
        try {
            ChaincodeEventOuterClass.ChaincodeEvent chaincodeEvent = ChaincodeEventOuterClass.ChaincodeEvent.parseFrom(getChaincodeAction().getEvents());

            return new ChaincodeEvent(chaincodeEvent.getChaincodeId(),
                    chaincodeEvent.getTxId(),
                    chaincodeEvent.getEventName(),
                    chaincodeEvent.getPayload().toByteArray());
        } catch (InvalidProtocolBufferException e) {
            throw new InvalidProtocolBufferRuntimeException(e);
        }
    }
